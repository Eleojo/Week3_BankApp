...
namespace BankApp.Methods
{
    internal class AccountServices
    {
        ...
        //    bool oppositeAccount = true;   // will tell user to create opposite of existing account type
        ...
        //    bool accountExits = accounts.Any(a => a.userId.Equals(userId) || a.accountType.Equals(accountType));
        //    User user = users.FirstOrDefault(user => user.Id.Equals(userId));

        //    if (accountExits)
        //    {
        //        Account existingAccount = accounts.SingleOrDefault(a => a.userId == userId);

        //        if (existingAccount != null)
        //        {
        //            //accountType = !oppositeAccount ? "Current" : "Savings";
        //            Console.WriteLine($"You already have a {existingAccount.accountType} account with us. To open another account it must be a {!oppositeAccount} account");
        //            return;
        //        }
